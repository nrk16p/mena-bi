...
export const STATIC_FLOWS: Record<string, FlowConfig> = {
  trip: {
    ...
    targetHref: "/datapipeline/data/trip",
    dynamic: false,
    unit: "เที่ยว",
    metric: null,
    categories: [],
  ...
  weight: {
    ...
    targetHref: "/datapipeline/data/weight",
    dynamic: false,
    unit: "เที่ยว",
  ...
  "transport-cost": {
    ...
    targetHref: "/datapipeline/data/transport-cost",
    dynamic: false,
    unit: "แถว",
...
export function toFlowConfig(d: DynamicFlowDoc): FlowConfig {
  return {
    ...
    targetHref: `/datapipeline/data/view?flow=${d.flowKey}`,
    dynamic: true,
    unit: "แถว",
    metric: null,
    categories: [],
